...
export default function FloatingTabBar({
  ...
  const dynamicStyles = {
    ...
    background: {
      ...styles.background,
      backgroundColor: isDark
        ? (Platform.OS === 'ios' ? 'transparent' : 'rgba(26, 26, 26, 0.1)')
        : (Platform.OS === 'ios' ? 'transparent' : 'rgba(255, 255, 255, 0.1)'),
    },
    indicator: {
      ...styles.indicator,
      backgroundColor: colors.main + '20', // Use main color with opacity
                ...
                >
                  <View style={styles.tabContent}>
                    <IconSymbol
                      name={tab.icon}
                      size={24}
                      color={isActive ? colors.main : (isDark ? colors.textSecondaryDark : colors.textSecondary)}
                    />
                    <Text
                      style={[
                        styles.tabLabel,
                        { color: isDark ? colors.textSecondaryDark : colors.textSecondary },
                        isActive && { color: colors.main, fontWeight: '600' },
                      ]}
                    >
                      {tab.label}
                    </Text>
